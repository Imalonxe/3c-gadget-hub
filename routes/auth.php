...
Route::middleware('guest')->group(function () {
    ...
    // After social provider returns, if the user is new we require consent before creating account
    Route::get('login/{provider}/consent', [\App\Http\Controllers\Auth\SocialAuthController::class, 'consent'])
        ->name('social.consent');
    Route::post('login/{provider}/consent', [\App\Http\Controllers\Auth\SocialAuthController::class, 'consentConfirm'])
        ->name('social.consent.confirm');
