...
export default function Edit({ mission, categories }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        ab_group: mission.ab_group || 'none',
        slots: mission.slots.map(slot => ({ category_id: slot.category_id })),
    });
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.missions.update', mission.id));
    };
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            <h2 className="text-xl font-semibold text-gray-800 mb-6">Edit Mission: {mission.name}</h2>
...
Edit.layout = page => <AdminLayout children={page} title="Edit Mission" />;
