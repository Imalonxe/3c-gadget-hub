...
export default function Edit({ provider }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.shipping-providers.update', provider.id));
    };
            ...
            <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
                <div className="px-4 py-6 sm:px-0">
                    ...
                    <div className="mb-6">
                        ...
                        <h1 className="text-2xl font-semibold text-gray-900">Edit Shipping Provider</h1>
                        <p className="mt-1 text-sm text-gray-600">Editing: {provider.name}</p>
                    </div>
...
Edit.layout = page => <AdminLayout children={page} title="Edit Shipping Provider" />;
