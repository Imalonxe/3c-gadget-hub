...
export default function Index({ promptpay_phone = '' }) {
    const [phone, setPhone] = useState(promptpay_phone);
...
Index.layout = page => <AdminLayout children={page} title="Payment Settings" />;
